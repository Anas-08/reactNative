...
import CheckBoxId from './CheckBoxId';
import RadioId from './RadioId';
        ...
        //    const [selectGender, setSelectGender] = useState(null)
          ...
          const [gender, setGender] = useState([
            ...
            const handleRadioChange = (id) => {
                ...
                gender.map((value) => ({
                        ...value,    
                        isChecked: value.id === id,
                    }));
                    // console.log();
                    console.log(id, updatedRadio)
  ...
  return (
    ...
    <SafeAreaView>
      ...
      <View>
        ...
        <RadioId data={gender} handleChange={handleRadioChange}  />
      </View>

      <View>
        <Text style={[styles.common]} >Select Hobbies: </Text>

        <CheckBoxId data={hobby} handleChange={handleCheckBoxChange}  />
      </View>
